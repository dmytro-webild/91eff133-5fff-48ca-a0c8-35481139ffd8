...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        },
        {
          ...
          alt: "Having lunch in spacious restaurant",
        },
        {
          src: "http://img.b2bpic.net/free-photo/woman-listening-mens-stories_329181-17786.jpg",
          alt: "Woman listening to mens stories",
        },
      ]}
      ...
      features={[
        {
          tag: "Ποιότητα",
          title: "Φρέσκα Υλικά",
          subtitle: "Από την περιοχή",
          description: "Χρησιμοποιούμε μόνο τα καλύτερα προϊόντα από τοπικούς παραγωγούς.",
          imageSrc: "http://img.b2bpic.net/free-photo/view-raw-vegetables-composition_23-2148643062.jpg",
        },
        {
          tag: "Παράδοση",
          title: "Συνταγές",
          subtitle: "Οικογενειακές",
          description: "Αυθεντικές γεύσεις που θυμίζουν το σπίτι και τη μαμά.",
          imageSrc: "http://img.b2bpic.net/free-photo/shah-pilaf-with-dried-fruits-human-hand-round-plate_176474-2986.jpg",
        },
        {
          tag: "Χώρος",
          title: "Ατμόσφαιρα",
          subtitle: "Οικογενειακή",
          description: "Ένας χώρος ιδανικός για κάθε περίσταση και κάθε ηλικία.",
      ...
      products={[
        {
          ...
          price: "8€",
          imageSrc: "http://img.b2bpic.net/free-photo/salad-with-feta-cheese-olives-fresh-vegetables_181624-23691.jpg",
        },
        {
          id: "p2",
          name: "Ψητό Ψάρι ημέρας",
          price: "18€",
        ...
        },
        {
          ...
          price: "12€",
          imageSrc: "http://img.b2bpic.net/free-photo/pottery-pan-with-sauteed-dish-covered-with-melted-cheese_140725-8664.jpg",
        },
        {
          id: "p4",
          name: "Ποικιλία Ορεκτικών",
          price: "14€",
          imageSrc: "http://img.b2bpic.net/free-photo/sandwiches-with-mixed-vegetables-black-olives_114579-5980.jpg",
        },
        {
          id: "p5",
          name: "Σουβλάκι Χειροποίητο",
          price: "13€",
          imageSrc: "http://img.b2bpic.net/free-photo/cooked-meat-veggies-kebab-tomatoes_23-2148651058.jpg",
        },
        {
          id: "p6",
          name: "Μπακλαβάς",
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "f1",
          title: "Χρειάζεται κράτηση;",
          content: "Σας προτείνουμε πάντα να κάνετε κράτηση, ειδικά τα Σαββατοκύριακα.",
        },
        {
          id: "f2",
          title: "Υπάρχει parking;",
          content: "Υπάρχει άνετος χώρος στάθμευσης στη γύρω περιοχή.",
        },
        {
          id: "f3",
          title: "Δέχεστε κατοικίδια;",
          content: "Ο εξωτερικός μας χώρος είναι φιλικός προς τα κατοικίδια.",
        },
      ]}
